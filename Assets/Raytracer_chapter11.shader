...
//        _MainTex ("Texture", 2D) = "white" {}
	...
	void GetSphere(int i, out Sphere sph)
	{
		...
		// left sphere
		else if (i == 2) { sph.center = float3(-1, 0, -1); sph.radius = 0.5; sph.materialtype = 2; sph.matproperties = float4(1, 1, 1, 1.2);}
		// left inner sphere
		else if (i == 3) { sph.center = float3( -1, 0, -1); sph.radius = -0.4; sph.materialtype = 2; sph.matproperties = float4(1, 1, 1, 1.2);}
		// right sphere
		else if (i == 4) { sph.center = float3( 1, 0, -1); sph.radius = 0.5; sph.materialtype = 1; sph.matproperties = float4(0.8, 0.6, 0.2, 0.8);}
	}		
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////
		fixed4 frag(v2f i) : SV_Target
		{
		    ...
		    float3 lookfrom = float3(-0.4, 0, 0.3);
