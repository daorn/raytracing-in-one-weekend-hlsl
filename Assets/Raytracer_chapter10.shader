...
//        _MainTex ("Texture", 2D) = "white" {}
	...
	void GetSphere(int i, out Sphere sph)
	{
		...
		// left sphere
		else if (i == 2) { sph.center = float3(-1, 0, -1); sph.radius = 0.5; sph.materialtype = 1; sph.matproperties = float4(0.8, 0.8, 0.8, 0.0);}
		// right sphere
		else if (i == 3) { sph.center = float3( 1, 0, -1); sph.radius = 0.5; sph.materialtype = 1; sph.matproperties = float4(0.8, 0.6, 0.2, 0.8);}
